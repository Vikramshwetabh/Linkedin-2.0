...
func corsMiddleware(next http.Handler) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Access-Control-Allow-Methods", "GET, POST, PUT, PATCH, DELETE, OPTIONS") // Allow all methods
...
func handleRoutes(w http.ResponseWriter, r *http.Request) {
	...
	switch {
	case r.URL.Path == "/register" && r.Method == "POST": //register handler
	...
	case r.URL.Path == "/jobs/disable" && r.Method == "PATCH": //disable the job
